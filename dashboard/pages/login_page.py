...
register_page(__name__, path="/login", title="Log In")
...
right_panel = login.LoginSvgPanel(
    src="/assets/img/register.svg", background="blue", padding=50
)

layout = login.LoginPage(left_panel=left_panel, right_panel=right_panel)
