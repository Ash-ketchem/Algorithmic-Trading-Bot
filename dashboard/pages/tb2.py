...
register_page(__name__, path="/tb2", title="Forward Test Table")

CELL_STYLE = {"padding": 10, "text-align": "center"}

HEADER_STYLE = {"padding": 5, "text-align": "center", "background-color": str(cd.BLUE)}
